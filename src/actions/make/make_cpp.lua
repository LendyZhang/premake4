...
--
	...
	function cpp.linker(cfg, cc)
		...
		local libpaths = _MAKE.esc(premake.getlinks(cfg, "siblings", "fullpath"))
		_p('  LDDEPS    +=%s',   make.list(libpaths))
		_p('  LIBS      +=%s%s', make.list(make.getstaticlibs(libpaths)), make.list(cc.getlinkflags(cfg)))
