...
--
-- Locates the PCH file on one of the include file search paths.
--

	function premake.locatepch(cfg)
		...
		for _, incdir in ipairs(cfg.includedirs) do
			...
			local abspath = path.getabsolute(path.join(cfg.location, incdir))
